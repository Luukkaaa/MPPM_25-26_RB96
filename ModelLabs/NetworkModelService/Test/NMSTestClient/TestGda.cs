	...
	{			
		...
		public ResourceDescription GetValues(long globalId)
		{
			...
			try
			{
                ...
                List<ModelCode> properties = GetSafePropertiesForType((DMSType)type) ?? modelResourcesDesc.GetAllPropertyIds((DMSType)type);
		...
		public List<long> GetExtentValues(ModelCode modelCode)
		{
			...
			{				
                ...
                List<ModelCode> properties = GetSafePropertiesForType(type) ?? modelResourcesDesc.GetAllPropertyIds(modelCode);
        ...
        private List<ModelCode> GetSafePropertiesForType(DMSType type)
        {
            switch (type)
            {
                ...
                case DMSType.ASSETINFO:
                    return new List<ModelCode>
                    {
                        ...
                        ModelCode.IDOBJ_ALIASNAME,
                        ModelCode.IDOBJ_DESCRIPTION,
                        ModelCode.ASSETINFO_ASSETMODEL,
                        ModelCode.ASSETINFO_ASSETS
                    };
                ...
                case DMSType.PRODUCTASSETMODEL:
                    return new List<ModelCode>
                    {
                        ...
                        ModelCode.IDOBJ_ALIASNAME,
                        ModelCode.IDOBJ_DESCRIPTION,
                        ModelCode.PRODASSETMODEL_CORPSTANDKIND,
                        ModelCode.PRODASSETMODEL_MODELNUMBER,
                ...
                case DMSType.SEAL:
                    return new List<ModelCode>
                    {
                        ...
                        ModelCode.IDOBJ_ALIASNAME,
                        ModelCode.IDOBJ_DESCRIPTION,
                        ModelCode.SEAL_APPLIEDDATETIME,
                        ModelCode.SEAL_CONDITION,
                        ModelCode.SEAL_KIND,
                ...
                case DMSType.COMMEDIA:
                    return new List<ModelCode>
                    {
                        ...
                        ModelCode.COMMEDIA_LIFECYCLE,
                        ModelCode.COMMEDIA_STATUS,
        ...
        private Dictionary<DMSType, ResourceDescription> CreateResourcesToInsert()
        {
            ...
            foreach (DMSType type in modelResourcesDesc.AllDMSTypes)
            {
                if (type != DMSType.MASK_TYPE)
                {
                    ...
                    {
                        bool isAssetDerived = (type == DMSType.ASSET || type == DMSType.ASSETCONTAINER || type == DMSType.COMMEDIA);
                        if (!isAssetDerived && propertyId.ToString().StartsWith("ASSET_"))
                        {
                            continue;
                        }
