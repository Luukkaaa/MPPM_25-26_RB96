...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.PRODASSETMODEL_CORPSTANDKIND, typeof(CorporateStandardKind));
			property2enumType.Add(ModelCode.PRODASSETMODEL_USAGEKIND, typeof(AssetModelUsageKind));
